		...
		<section id="about" className={styles.aboutSection}>
			<div className={styles.textabout}>
				...
				<p>
					...
					placer <strong  className={styles.bold}>le développement web</strong> au cœur de mon projet
					professionnel.
				</p>
				<p>
				...
				<p>
					Aujourd’hui, je transitionne vers le métier de  <strong  className={styles.bold}>Développeur Full Stack</strong>.
			...
			<ul className={styles.cardsAbout}>
				...
				<li>
					<h4>Soft Skills</h4>
					<p>
						Management d'équipe, Communication positive, Intelligence
						émotionnelle, Esprit critique
					</p>
				</li>
				<li>
					<h4>Gestion de Projet</h4>
					<p>
						Rigueur, Organisation, Analyse de données, Agilité (Scrum), Daily
						quotidien, Trello
					</p>
				</li>
				<li>
